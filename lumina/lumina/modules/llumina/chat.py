...
class LuminaChat:
    ...
    def __init__(self, store: DocumentStore):
        self.ds = store
        self.model = LlamaChatModel(n_threads=os.cpu_count() or 1, n_ctx_size=8192, max_tokens=4048)
    ...
    def ask(self, user_input: str) -> Generator[str, None, None]:
        ...
        yield from self.model.ask(self._get_prompt(_metadata, user_input))

    @staticmethod
    def _get_prompt(_metadata, _user_input) -> str:
        return f"{_metadata}, Me: {_user_input}"
